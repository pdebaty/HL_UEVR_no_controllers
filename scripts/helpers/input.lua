...
function M.handleInput(state, decoupledYawCurrentRot, isDecoupledYawDisabled, locomotionMode, controlMode, isLeftHanded, isFlightInvertY, snapAngle, smoothTurnSpeed, useSnapTurn, AlphaDiff, isInMenu, isWalking)
